<template>
  <h1>用户页面</h1>
  <el-button type="primary" @click="toInterface" style="position: absolute; top: 40px; right: 250px">查看接口</el-button>
  <el-button type="primary" @click="changePass" style="position: absolute; top: 40px; right: 150px">修改密码</el-button>
...
async function submitPass() {
  request.put('/user/change', changePassword.value).then(res=>{
    if( res.code === 0 ) {
